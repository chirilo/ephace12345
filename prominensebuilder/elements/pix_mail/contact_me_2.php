...
if($_POST)
{
    $to_Email       = "prominense.com@gmail.com"; //Replace with recipient email address
    $subject        = 'An email from Prominense contact form'; //Subject line for emails
    ...
    'X-Mailer: PHP/' . phpversion();
        ...
        // send mail
    $sentMail = @mail($to_Email, $subject, 'Subscribe using Prominense form, Name: '. $user_Name .'   -- Company: '. $user_Company .'   -- Email: '.$user_Email .'  -- Message: '. $user_Message, $headers);
