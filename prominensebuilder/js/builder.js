...
editableItems['.pix_builder_bg, .confirm_page_2'] = ['background-image', 'background-color', 'padding-top', 'padding-bottom', 'box-shadow', 'background-size', 'background-attachment'];
	...
	$('#second #elements li').each(function(){
		...
		$(this).draggable({
			...
			start: function(){
				...
				//switch to block mode // prominense
...
//=======================================================================================================================
// This part of code is licensed to prominense.com (http://themeforest.net/user/prominense) and not allowed to copy or reuse it
// Copyright prominense 2015
