...
<div class="home video-bg" id="home">
    ...
    <div class="video-container">
        <video autoplay muted loop>
            <!-- <source src="Public2/landing-b/enterphace_landing.webm" type="video/webm"> -->
                <source src="Public2/landing-b/file.mp4" type="video/mp4">
        </video>
    </div>

    <div class="wrap">

        <h2>#1 Communication Tool</h2>
        <p>Collate Social profiles, plan schedules, watch videos and read messages , all inside a single place.</p>

        <div class="controls">
            <!-- <button class="blue" onClick="window.location='/placetimenow/joyride' ">Get started</button> -->
            <a class="button blue" href="{{ URL::to('placetimenow/joyride') }}">Get started</a>
        </div>
...
<div class="cases clearfix" id="cases">
    ...
    <div class="wrap">
        ...
        <div class="visual">
            <img src="Public2/images/landing_screen1.png" alt="Demo" />
        </div>
            ...
            <div class="person">
                ...
                <div class="user-photo">
                    <a href="#" target="_blank">
                        <img src="Public2/images/tweets_avatars/marrie.jpg">
                    </a>
                </div>
...
<div class="cases light clearfix">
    ...
    <div class="wrap">
        ...
        <div class="visual">
            <img src="Public2/images/landing_screen2.png" alt="Demo" />
        </div>
        ...
        <div class="info">
            ...
            <div class="person">
                ...
                <div class="user-photo">
                    <a href="#" target="_blank">
                        <img src="Public2/images/tweets_avatars/felix.jpg">
                    </a>
                </div>
...
<div class="cases clearfix">
    ...
    <div class="wrap">
        ...
        <div class="visual">
            <img src="Public2/images/landing_screen3.png" alt="Demo" />
        </div>
        ...
        <div class="info">
            ...
            <div class="person">
                ...
                <div class="user-photo">
                    <a href="#" target="_blank">
                        <img src="Public2/images/tweets_avatars/ludwig.jpg">
                    </a>
                </div>
...
<div style="display: none;" id="sign-up" class="sign-up modal hidden">
    <div class="container">
        <div class="inner">
