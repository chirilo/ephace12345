...
Vestibulum auctor suscipit lobortis. Sed quis ipsum risus. Mauris vitae 
justo non felis pulvinar rhoncus. In quis massa ut risus sagittis 
luctus.
					</p>
		...
		<div class="timeline-item">
			...
			<div class="panel panel-default timeline-panel">
				...
				<div class="panel-body">
					<a class="timeline-img cboxElement" href="/assets/img/gallery2.jpg">
						<img src="/assets/img/gallery2.jpg" alt="Timeline Photo">
					</a>
					<a class="timeline-img cboxElement" href="/assets/img/gallery7.jpg">
						<img src="/assets/img/gallery7.jpg" alt="Timeline Photo">
					</a>
				</div>
			</div><!-- /panel -->
		</div><!-- /timeline-item -->
