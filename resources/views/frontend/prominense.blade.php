...
<div class="home video-bg" id="home">
    ...
    <div class="video-container">
        <video autoplay muted loop>
            <!-- <source src="Public3/landing-b/enterphace_landing.webm" type="video/webm"> -->
                <source src="Public3/landing-b/file.mp4" type="video/mp4">
        </video>
    </div>

    <div class="wrap">

        <h2>#1 Website Builder</h2>
        <p>Collate Social profiles, plan schedules, watch videos and read messages , all inside a single place.</p>

        <div class="controls">
            <a class="button blue" href="{{ URL::to('prominense/joyride') }}">Get started</a>
        </div>
...
<div class="cases clearfix" id="cases">
    ...
    <div class="wrap">
        ...
        <div class="visual">
            <img src="Public3/images/landing_screen1.png" alt="Demo" />
        </div>
            ...
            <div class="person">
                ...
                <div class="user-photo">
                    <a href="#" target="_blank">
                        <img src="Public3/images/tweets_avatars/marrie.jpg">
                    </a>
                </div>
...
<div class="cases light clearfix">
    ...
    <div class="wrap">
        ...
        <div class="visual">
            <img src="Public3/images/landing_screen2.png" alt="Demo" />
        </div>
        ...
        <div class="info">
            ...
            <div class="person">
                ...
                <div class="user-photo">
                    <a href="#" target="_blank">
                        <img src="Public3/images/tweets_avatars/felix.jpg">
                    </a>
                </div>
...
<div class="cases clearfix">
    ...
    <div class="wrap">
        ...
        <div class="visual">
            <img src="Public3/images/landing_screen3.png" alt="Demo" />
        </div>
        ...
        <div class="info">
            ...
            <div class="person">
                ...
                <div class="user-photo">
                    <a href="#" target="_blank">
                        <img src="Public3/images/tweets_avatars/ludwig.jpg">
                    </a>
                </div>
