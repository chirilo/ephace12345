 ...
 * http://www.opensource.org/licenses/mit-license.php
 -->
  ...
  <head>
    ...
    <!-- Attach our CSS -->
    <link rel="stylesheet" href="{{ asset('joyride-2.1.css') }}">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="six columns">
        <img id="numero5" src="{{ asset('430x200.gif') }}">
      </div>
    </div>
   ...
   <div class="row">
    ...
    <!-- Run the plugin -->
    <script type="text/javascript" src="{{ asset('jquery-1.10.1.js') }}"></script>
    <script type="text/javascript" src="{{ asset('jquery.cookie.js') }}"></script>
    <script type="text/javascript" src="{{ asset('modernizr.mq.js') }}"></script>
    <script type="text/javascript" src="{{ asset('jquery.joyride-2.1.js') }}"></script>
    <script>
