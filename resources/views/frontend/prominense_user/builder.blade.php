...
<html lang="en">
  <head>
    <link type="text/css" href="https://enterphace.com/PlaceTimeNowVideoChatApps3jskyzjpr/cometchatcss.php" rel="stylesheet" charset="utf-8">
    <script type="text/javascript" src="https://enterphace.com/PlaceTimeNowVideoChatApps3jskyzjpr/cometchatjs.php" charset="utf-8"></script>
    <meta charset="utf-8">
    <title>Prominense Builder | Build Your Own Web Presence</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <!-- Loading Bootstrap -->
    <link href="{{ asset('/ProminenseBuilderApps3jskyzjpr/bootstrap/css/bootstrap.css')}}" rel="stylesheet">

    <!-- Loading Flat UI -->
    <link href="{{ asset('/ProminenseBuilderApps3jskyzjpr/css/flat-ui.css')}}" rel="stylesheet">
    
    <link href="{{ asset('/ProminenseBuilderApps3jskyzjpr/css/style.css')}}" rel="stylesheet">
    
    <link href="{{ asset('/ProminenseBuilderApps3jskyzjpr/css/spectrum.css')}}" rel="stylesheet">
    <link href="{{ asset('/ProminenseBuilderApps3jskyzjpr/css/chosen.css')}}" rel="stylesheet">
    
    <link rel="shortcut icon" href=""> 
    
    <!-- Font Awesome -->
    <link href="{{ asset('/ProminenseBuilderApps3jskyzjpr/css/font-awesome.css')}}" rel="stylesheet">
    
    <link href="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/redactor/redactor.css')}}" rel="stylesheet">
  ...
  <body>
  	...
  	<div class="menu" id="menu">
  		...
  		<div class="main" id="main">
  			...
  			<h3><img src="/ProminenseBuilderApps3jskyzjpr/images/prominense.png"></h3>
        <hr>
  			
  			<ul id="elements">
  				<li><a href="#" id="all">All Items</a></li>
  			</ul>
    ...
    <div class="container">
    	...
    	<div class="pix_copy_right"><span>All Rights Reserved &copy; 2015 Prominense by Enterphace</span></div>      
    </div><!-- /.container -->
    ...
    <div id="hidden">
    	<iframe src="{{ asset('/ProminenseBuilderApps3jskyzjpr/elements/skeleton.html')}}" id="skeleton"></iframe>
    </div>
...
<!-- export Project popup -->
  <div class="modal fade" id="projModal" tabindex="-1" role="dialog" aria-hidden="true">
	...
	<div id="loader">
		<img src="/ProminenseBuilderApps3jskyzjpr/images/Enterphace.gif" alt="Loading...">
		<span>Loading Enterphace Elements...</span>
    <div class="spinner">
    ...
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/jquery-1.8.3.min.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/jquery-ui.min.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/jquery.ui.touch-punch.min.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/bootstrap.min.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/bootstrap-select.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/bootstrap-switch.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/flatui-checkbox.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/flatui-radio.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/jquery.tagsinput.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/flatui-fileinput.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/jquery.placeholder.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/jquery.zoomer.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/application.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/spectrum.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/chosen.jquery.min.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/redactor/redactor.min.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/redactor/table.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/redactor/bufferButtons.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/src-min-noconflict/ace.js')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/elements.json')}}"></script>
    <script src="{{ asset('/ProminenseBuilderApps3jskyzjpr/js/builder.js')}}"></script>
<!-- 
